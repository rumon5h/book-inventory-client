...
import brandImg13 from '../../images/nickelodeon.jpg';
...
import brandImg17 from '../../images/sony.jpg';
...
const Brands = () => {
    const brandImages = [
        brandImg1, brandImg2, brandImg3, brandImg4, brandImg5, brandImg6, brandImg7, brandImg8, brandImg9, brandImg10, brandImg12,brandImg13,brandImg14,brandImg15,brandImg16,brandImg17,brandImg18,brandImg19
    ];

    return (
        <div className='py-16 my-10'>
            <h2 className='text-5xl font-bold  text-center text-gray-900'>Trusted by Big Names</h2>
            <div className='grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 justify-items-center mt-3'>
            {
                brandImages.map(brandImage => <img className='m-2' width='200' height='200' key={brandImage} src={brandImage} alt="brand"></img>)
            }
            </div>
        </div>
    )
